...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/registrazion.css')); ?>">
    ...
    <script type="text/javascript">
            const CONTROLLO_ROUTE = "<?php echo e(route('controlloUsername')); ?>";
        </script>
...
</html><?php /**PATH C:\Users\monic\OneDrive\Desktop\prova\resources\views/signup.blade.php ENDPATH**/ ?>