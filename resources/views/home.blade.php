...
<body>
    ...
    <section>
    <span id="avventura"><a href="{{ url('avventura') }}"><img class="i1" src="immagini/avventura.jpeg"> </a><h2>In cerca di avventura?</h2><br><h3>Sei alla ricerca delle
        ...
        vulcani, scroscianti cascate, impenetrabili foreste tropicali e tanto altro ancora.</h3><a href="{{ url('avventura') }}">
            <h6>Scopri di più...</h6></a></span>
    <span id="cultura"><a href="{{ url('cultura') }}"><img class="i2" src="immagini/cultura.jpeg"></a><h5>Alla scoperta del passato...</h5><br><h4> Viaggi che hanno un 
        ...
        Muraglia al misticismo dei monasteri tibetani.</h4><a href="{{ url('cultura') }}"><h6> Scopri di più...</h6></a></span>
    <span id="divertimento"><a href="{{ url('divertimento') }}"><img class="i3" src="immagini/divertimento.jpeg"></a><h2>Divertimento assicurato!</h2><br><h3>Goditi una 
        ...
        mete per vivere il viaggio più bello e divertente della tua vita!<br> Preparati a partire per una vacanza che non si
         potrà descrivere, ma soltanto vivere!</h3><br><a href="{{ url('divertimento') }}"><h6>Scopri di più...</h6></a> </span>
    <span id="relax"><a href="{{ url('relax') }}"><img class="i4" src="immagini/relax.jpeg"></a><h5>Sole, mare e... relax</h5><br><h4>Goditi un po' di serenità in 
        ...
        Kerala e tanto altro ancora. </h4><a href="{{ url('relax') }}"><h6>Scopri di più...</h6></a> </span>        
    </section>
